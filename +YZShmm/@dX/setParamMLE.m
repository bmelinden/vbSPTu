...
%
% p0,D,A,v: parameter mode values.
% rms     : instead of v, the rms error = sqrt(v) an be specified.
% npc     : number of pseudo-counts (default 1e5), setting it only affects
%           arguments later in the parameter-value list. 
npc=1e5;
