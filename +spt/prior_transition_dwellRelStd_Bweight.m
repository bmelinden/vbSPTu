function [wa,wB]=prior_transition_dwellRelStd_Bweight(N,dwellStepMean,dwellStepRelStd,Bweight)
% [wa,wB]=spt.prior_transition_dwell_Bweight(N,dwellStepMean,dwellStepRelStd,Bweight)
%
...
% dwellSteps   : prior mean value of mean dwell time [timesteps]
% dwellStepRelStd : prior std of mean dwell time, in units of the mean value []
...
t0Var=(dwellStepMean*dwellStepRelStd)^2; % prior dwell time variance
