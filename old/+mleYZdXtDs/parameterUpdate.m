...
% A parameter update iteration (MLE) on a diffusive YZdXtDs HMM, including
...
W.P.d = sum(W.S.pst(W.YZ.i1-1,:),1)./sum(W.S.pst,1);

% check for unoccupied rows, and add a minimal pseduocount to them
