...
switch nargout
    ...
    case 2
        [W.S,W.lnL,sMaxP]     =spt.hiddenStateUpdate(dat,W.YZ,tau,R,iLambda,lnLambda,lnp0,lnQ,lnVs,iVs);
    case 3
        [W.S,W.lnL,sMaxP,sVit]=spt.hiddenStateUpdate(dat,W.YZ,tau,R,iLambda,lnLambda,lnp0,lnQ,lnVs,iVs);
end
